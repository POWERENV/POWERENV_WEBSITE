 ...
 */
//=========================================================================================
export function PNodeOpenOSTerminalSession(pnodeID : Number){
 ...
 */
//=========================================================================================
export function PNodeCloseOSTerminalSession(sessionID : Number) {
    return new Promise((resolve, reject) => {
 ...
 */
//=========================================================================================
export function PNodeSendCommandToOSTerminalSession(sessionID : Number, command : string){
    return new Promise((resolve, reject) => {
