...
export function PPoolUpdateReadmeText(ppoolID : Number, pgridID : Number, newReadmeTXT : string){
...
export async function CreateNewPPool(ppoolName : string, ppoolTag : string, ppoolReadmeText : string, ppoolAssociatedPGridID : Number) {
    const requestBody = {
        ppool_id: 0,
...
export async function DeletePPool(ppool_id : Number) {
    return new Promise((resolve, reject) => {
