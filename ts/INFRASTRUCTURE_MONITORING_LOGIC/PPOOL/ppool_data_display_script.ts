 ...
 */
//=========================================================================================
export async function displayPPoolDashboardData(pgridID : Number, ppoolID : Number, e : Event | null, generateWholeContent : Boolean)
{
    ...
    displayPPoolSettingsMenu(dashboardData, pgridID);
    ...
    let pgridNewDashboardData : typeDefinitions.PGridDashboardData = await dataRetrievalScript.getPGridDashboardData(pgridID) as typeDefinitions.PGridDashboardData;

    if(generateWholeContent == true) mainScript.displayPGridTreeStructureInfo(pgridNewDashboardData);
}

//=========================================================================================
/**
 * Sets up PPool settings centered modal menu.
 ...
 */
//=========================================================================================
function displayPPoolSettingsMenu(dashboardData : typeDefinitions.PPoolDashboardData, pgridID : Number) {
...
function displayPPoolMainInfo(dashboardData : typeDefinitions.PPoolDashboardData, _pgridID : Number, e : Event | null)
{
    ...
    document.getElementById("reloadSettingsBTN")!.addEventListener("click", async () => {
        await displayPPoolDashboardData(_pgridID, dashboardData.ppoolFullInfo.ppool_id, e, true);
    });
}
...
function createNewPNode(dashboardData : typeDefinitions.PPoolDashboardData, event : Event | null) {
    ...
    const pnodeSyncMachineDataBTNAction = new typeDefinitions.FunctionObject(async (args : Array<any>) => {
        ...
        const newPPoolCreationWizzardSubmitAction = async (e : Event, selfInstance : editorComponents.sideConfigurationEditWizzard) => {
            ...
            displayPPoolDashboardData(dashboardData.ppoolFullInfo.ppool_parent_pgrid_id, dashboardData.ppoolFullInfo.ppool_id, event, true);
        };
