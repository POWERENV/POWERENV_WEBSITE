...
var signalRWSSConnection : any;
var telnetSessionID : Number;
 ...
 */
//=========================================================================================
export function setUpPNodeConsoleListeners(dashboardData : typeDefinitions.PNodeDashboardData)
{
 ...
 */
//=========================================================================================
export async function openASMIWebConsole(dashboardData : typeDefinitions.PNodeDashboardData)
{
    let loginResponse : string = await fspCommunicationScript.PNodeOpenASMISession(dashboardData.pnode_full_info.pnode_id) as string;
 ...
 * @param {typeDefinitions.PNodeDashboardData} dashboardData The dashboard data object containing information about the PNode.
 */
//=========================================================================================
export async function closeASMIWebConsole(dashboardData : typeDefinitions.PNodeDashboardData)
{
 ...
 */
//=========================================================================================
export async function ASMICommandInputSubmitEvent(e : Event, dashboardData : typeDefinitions.PNodeDashboardData)
{
    e.preventDefault();

    let ipt = (document.getElementById("consoleModalBoxViewportInput")as HTMLInputElement)!.value;
    let commandResponse : typeDefinitions.ASMICommandResponse = await fspCommunicationScript.PNodeSendASMICommand(dashboardData.pnode_full_info.pnode_id, ipt) as typeDefinitions.ASMICommandResponse;
    ...
    (document.getElementById("consoleModalBoxViewportInput")as HTMLInputElement)!.value = "";
}
 ...
 */
//=========================================================================================
export async function openOSCommandTerminal(dashboardData : typeDefinitions.PNodeDashboardData)
{
    let loginResponse = await osCommunicationScript.PNodeOpenOSTerminalSession(dashboardData.pnode_full_info.pnode_id);

    editorComponents.showOSConsoleBox(async () => {
        await osCommunicationScript.PNodeCloseOSTerminalSession(telnetSessionID);
    }, async (e : Event, instance : editorComponents.consoleModalBox) => {
        const ipt = await osCommandInputSubmitEvent(e, dashboardData);
        if(ipt == "exit") {
            await osCommunicationScript.PNodeCloseOSTerminalSession(telnetSessionID);
            editorComponents.hideASMIConsoleBox();
        }
    });
    ...
    signalRWSSConnection.on("ReceiveTerminalOutput", (data : string) => {
 ...
 */
//=========================================================================================
export async function osCommandInputSubmitEvent(e : Event | null, dashboardData : typeDefinitions.PNodeDashboardData)
{
    if(e != null) e.preventDefault();

    let ipt = (document.getElementById("consoleModalBoxViewportInput") as HTMLInputElement)!.value;
    let commandResponse : string = await osCommunicationScript.PNodeSendCommandToOSTerminalSession(telnetSessionID, (ipt == "" || ipt == "exit") ? "echo" : ipt) as string;
    let ttyViewport = document.getElementById("consoleModalBoxConsoleViewport")!;
...
export async function osTerminalContentRealTimeUpdate(dashboardData : typeDefinitions.PNodeDashboardData)
{
 ...
 */
//=========================================================================================
export function setUpPNodePowerActionsEventListeners(dashboardData : typeDefinitions.PNodeDashboardData)
{
