...
*/
//=========================================================================================
export async function displayPNodesDashboardData(_pnodeID : Number, _ppoolID : Number, _pgridID : Number)
{
    ...
    document.getElementById("reloadSettingsBTN")!.addEventListener("click", async (e) => {
        await displayPNodesDashboardData(_pnodeID, _ppoolID, _pgridID);
    });

    document.getElementById('changePNodeReadmeBTN')!.addEventListener('click', () => {
        const changesSaveOperation = (e : Event, selfInstance : pnodeEditors.sideConfigurationEditWizzard) => {
            const newReadmeTXT = (document.getElementById('readmeTextTextArea') as HTMLTextAreaElement)!.value;
            pnodeDataEditScript.PNodeUpdateReadmeText(_pnodeID, _ppoolID, _pgridID, newReadmeTXT);
        };
        const readmeTextEditorBox = new pnodeEditors.sideConfigurationEditWizzard('Edit Readme Text', changesSaveOperation);
    ...
    displayPNodesFSPInfo(dashboardData, _ppoolID, _pgridID);
    displayPNodesMachineInfo(dashboardData);
    displayPNodesNetworkInterfacesInfo(dashboardData, _ppoolID, _pgridID);
...
*/
//=========================================================================================
function displayPNodesMainInfo(dashboardData : typeDefinitions.PNodeDashboardData)
{
    ...
    document.getElementById("_propsPNodeID")!.innerText = dashboardData.pnode_full_info.pnode_id.toString();
...
*/
//=========================================================================================
function displayPNodesFSPInfo(dashboardData : typeDefinitions.PNodeDashboardData, _ppoolID : Number, _pgridID : Number)
{
    document.getElementById("_pnodeFSPID")!.innerText = dashboardData.pnodeFSPInfo.fspid.toString();
    ...
    document.getElementById("_pnodeFSPLocalDateTime")!.getElementsByTagName('button')[0]!.addEventListener('click', () => {
        editPNodeASMIDateTimeEvent(dashboardData, _ppoolID, _pgridID);
    });
}
...
*/
//=========================================================================================
function editPNodeASMIDateTimeEvent(dashboardData : typeDefinitions.PNodeDashboardData, _ppoolID : Number, _pgridID : Number)
{
    const changesSaveOperation = (e : Event, instance : pnodeEditors.sideConfigurationEditWizzard) => {
        const newLocalDateTime = instance.struct_inputFields.editBoxLocalDateTimeInput;
        fspCommunicationScript.PNodeUpdateFSPLocalDateTime(dashboardData.pnode_full_info.pnode_id, newLocalDateTime, _ppoolID, _pgridID);
    };

    let fspLocalDateTimeEditorBox = new pnodeEditors.sideConfigurationEditWizzard('Edit FSP ASMI Local DateTime', changesSaveOperation);
...
*/
//=========================================================================================
function displayPNodesMachineInfo(dashboardData : typeDefinitions.PNodeDashboardData)
{
...
*/
//=========================================================================================
function displayPNodesNetworkInterfacesInfo(dashboardData : typeDefinitions.PNodeDashboardData, _ppoolID : Number, _pgridID : Number)
{    
        ...
        requestAnimationFrame(() => {
            if(dashboardData.pnode_full_info.pnodeActivenessState == false) {
                ...
                document.getElementById(`NICRES_${i}`)!.addEventListener('click', () => {
                    const changesSaveOperation = (e : Event, instance : pnodeEditors.sideConfigurationEditWizzard) => {
                        const ethIndex = Number(dashboardData.pnodeNICInfo[i]!.pnode_nic_name.substring(3));
                    ...
                    const ipAddressTypeDPDClickAction = (args : {instance : pnodeEditors.sideConfigurationEditWizzard }) => {
                    ...
                    let networkInterfaceCardEditWizzard = new pnodeEditors.sideConfigurationEditWizzard('Edit NIC Settings', changesSaveOperation);
                    let editBoxIPAddressTypeBTNClickAction : typeDefinitions.FunctionObject = new typeDefinitions.FunctionObject(ipAddressTypeDPDClickAction, [{instance : networkInterfaceCardEditWizzard}]);
                    networkInterfaceCardEditWizzard.insertDropdownField('editBoxIPAddressTypeBTN', 'editBoxIPAddressTypeDropdownList', 'Select NIC IP Address Type:', ['STATIC', 'DYNAMIC'], dashboardData.pnodeNICInfo[i]!.pnode_nic_ip_address_type.toUpperCase(), editBoxIPAddressTypeBTNClickAction);
...
*/
//=========================================================================================
export function displayPNodesETHAccessPoliciesInfo(dashboardData : typeDefinitions.PNodeDashboardData, _ppoolID : Number, _pgridID : Number)
{
    ...
    document.getElementById("_pnodeAddAccessPolicy")!.addEventListener("click", () => {
        const changesSaveOperation = (e : Event, instance : pnodeEditors.sideConfigurationEditWizzard) => {
            ...
            fspCommunicationScript.PNodeInsertETHAccessPolicy(pnodeCOMID, instance.struct_inputFields.editBoxIPAddressInput, instance.struct_dropdownFields.editBoxIPAddressTypeBTN, policyIndex, _ppoolID, _pgridID);
        };

        let ethAccessPolicyWizard = new pnodeEditors.sideConfigurationEditWizzard('Add Network Access Policy', changesSaveOperation);
...
*/
//=========================================================================================
function displayPNodesLoginAudits(dashboardData : typeDefinitions.PNodeDashboardData)
{
    document.getElementById("_pnodeLoginAuditsCount")!.innerText = dashboardData.pnodeLoginAudits.length.toString();
...
*/
//=========================================================================================
function displayPNodesOperationHistory(dashboardData : typeDefinitions.PNodeDashboardData)
{
    document.getElementById("_pnodeOperationLogsCount")!.innerText = dashboardData.pnodeSingleOperationHistory.length.toString();
...
*/
//=========================================================================================
function displayPNodesErrorLogs(dashboardData : typeDefinitions.PNodeDashboardData)
{
    document.getElementById("_pnodeErrorLogsOverviewCount")!.innerText = dashboardData.pnodeErrorLogs.length.toString();
    ...
    for(let i = 0; i < dashboardData.pnodeErrorLogs.length; i++){
        ...
        requestAnimationFrame(() => {
            ...
            currentLine.addEventListener('click', () => {
                const errorLogDetailsSidePanel = new pnodeEditors.sideConfigurationEditWizzard('Error Log Details', null);
