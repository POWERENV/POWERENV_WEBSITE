...
export async function getUserNotificationsData(UserID : Number) {
...
export async function markNotificationAsResolved(UserID : Number, NotificationID : Number) {
  return new Promise((resolve, reject) => {
    const name = fetch(
...
export async function getUserGlobalEventsCadenceStatsData(interval : Number) {
  return new Promise((resolve, reject) => {
    const name = fetch(
